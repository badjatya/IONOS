...
function plus02() {
    ...
    document.getElementById("cross02").style.display = "block";
...
function cross02() {
    ...
    document.getElementById("cross02").style.display = "none";
...
function plus03() {
    ...
    document.getElementById("cross03").style.display = "block";
...
function cross03() {
    ...
    document.getElementById("cross03").style.display = "none";
